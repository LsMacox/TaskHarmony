...
const route = useRoute('ui-pages-account-settings-tab')
...
definePage({ meta: { navActiveLink: 'ui-pages-account-settings-tab' } })
</script>
  ...
  <div>
    ...
    >
      <VTab
        ...
        :key="item.icon"
        :value="item.tab"
        :to="{ name: 'ui-pages-account-settings-tab', params: { tab: item.tab } }"
      >
        <VIcon
          size="20"
          start
